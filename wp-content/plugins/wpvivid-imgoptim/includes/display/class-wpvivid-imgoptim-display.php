...
class WPvivid_ImgOptim_Display
{
    ...
    public function welcome_bar()
    {
        ...
        <div class="wpvivid-nav-bar wpvivid-clear-float">
            ...
            <span><?php _e('It is recommended to back up the entire website with', 'wpvivid-imgoptim');?> <a href="<?php echo esc_url($url)?>">WPvivid Backup & Migration plugin (It's free)</a> before optimizing images.</span>
        </div>
        <?php
    }
    ...
    public function overview()
    {
        ...
        <div class="wpvivid-two-col">
            ...
            <div>
                ...
                <span><a href="<?php echo esc_url($admin_url);?>"><?php _e('Setting', 'wpvivid-imgoptim');?></a></span>
            </div>
        </div>
        <script>
