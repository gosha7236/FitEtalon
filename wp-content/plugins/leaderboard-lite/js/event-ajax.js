...
var ajaxNonce = customAjaxHandle.ajax_nonce;
(function( $ ) {
$(function(){ 
	///////////////////////////////////////////////////////////////Add Competition///////////////////////////////////////////////////////////////
	...
	//////////////////////////*************************************/////////////////////// Division ////////////////////////////**************************************/////////////////////////////
	/////////////////////////////////////////////Add Division//////////////////////////////////////////////////////
	$('.addDivision').bind( 'click', function(e) { //alert();
	...
	$('body').on('click', '.addEvent', function (){
	   var event_organizer_email 		= $('#event_organizer_email').val();	
		...
		var event_enable_booking = "";
		if($('#event_enable_booking').is(":checked")){
			event_enable_booking = "on";
		}else if($('#event_enable_booking').is(":not(:checked)")){
			 event_enable_booking = "off";
		}
	...
	$('body').on('click', '.editEventSave', function (){
		...
		var event_enable_booking = "";
		if($('#edit_event_enable_booking').is(":checked")){
			event_enable_booking = "on";
		}else if($('#edit_event_enable_booking').is(":not(:checked)")){
			 event_enable_booking = "off";
		}
	...
	$('body').on('click', '.addCompetitor', function (){
	   var competitor_name 						= $('#competitor_name').val();	
		...
		var competitor_status = "";
		if($('#competitor_status').is(":checked")){
			competitor_status = "on";
		}else if($('#competitor_status').is(":not(:checked)")){
			 competitor_status = "off";
		}
	...
	$('.deleteCompetitor').bind( 'click', function(e) { 
       ...
       $.ajax({
			...
			beforeSend:function(){
				 return confirm("Are you sure? Once you delete this account, there\'s no getting it back. Make sure you want to do this.");
			},
			success : function( response ) {
				if(response != 0){
	...
	$('body').on('click', '.editCompetitorSave', function (){
		...
		var competitor_status = "";
		if($('#edit_competitor_status').is(":checked")){
			competitor_status = "on";
		}else if($('#edit_competitor_status').is(":not(:checked)")){
			 competitor_status = "off";
		}
       $.ajax({
            type: 'POST',
	...
	$('.addWorkout').bind( 'click', function(e) { 
	   ...
	   var event_workout_enable = "";
		if($('#event_workout_enable').is(":checked")){
			event_workout_enable = "on";
		}else if($('#event_workout_enable').is(":not(:checked)")){
			 event_workout_enable = "off";
		}
	...
	$('body').on('click', '.editWorkoutSave', function (){
	   ...
	   var event_workout_enable = "";
		if($('#edit_event_workout_enable').is(":checked")){
			event_workout_enable = "on";
		}else if($('#edit_event_workout_enable').is(":not(:checked)")){
			 event_workout_enable = "off";
		}
	...
	$('body').on('click', '#event_score_workout', function (){ 
	   ...
	   $.ajax({
            ...
            data: {
                'workout_id': workout_id,
                'action': 'lbd_event_workout_measurement_unit',
				'security': ajaxNonce 
            },
			success : function( response ) {
				if(response != 0){
					$('#score_unit').html(response);
				}
			}
        });
	return false;
	}); 
	$('body').on('click', '#edit_event_score_workout', function (){ 
	   var workout_id = $(this).val();
	   $.ajax({
            type: 'POST',
            url: ajaxUrl,
	...
	$('.addScore').bind( 'click', function(e) { 
	   ...
	   var event_score_point = $('#event_score_point').val();
       ...
       $.ajax({
            ...
            data: {
				...
				'event_score_point':event_score_point,
	...
	$('body').on('click', '.editScoreSave', function (){
	   ...
	   var event_score = $('#edit_event_score').val();
	    var event_score_point = $('#edit_event_score_point').val();
	   var event_score_proof = $('#event_score_proof').val();
